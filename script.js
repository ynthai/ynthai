...
function handleDeviceOrientation(event) {
    ...
    let offset = gamma * 0.5; // Медленное смещение в зависимости от наклона
    ...
    stars.forEach(star => {
        ...
        // Убираем ограничение движения, чтобы звёздочки могли выходить за пределы экрана
...
// Сохраняем начальные позиции звёздочек
const stars = document.querySelectorAll(".star");
stars.forEach(star => {
    star.dataset.initialX = parseFloat(star.style.left); // Сохраняем начальное положение по X
});
